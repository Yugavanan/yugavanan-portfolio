      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div ref={ref} className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Hey there! I’m a curious and creative developer who loves bringing
              ideas to life — whether it's through clean code, smart design, or
              just experimenting with something new. I enjoy building projects
              that not only work well but also look and feel great to use.
            </motion.p>
            ...
            >
              My journey into tech started with a simple love for computers and
              figuring out how things work. That curiosity led me to explore
              coding — especially with Python — and over time, I’ve built up my
              skills by learning, building, and failing (then fixing it again!).
              I care deeply about writing clean, understandable code and
              designing user experiences that make a difference in the real
              world.
            </motion.p>
          </motion.div>
        </div>
