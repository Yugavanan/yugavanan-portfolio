...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      longDescription:  `Student Task Manager is a full-stack web application built using React for the frontend and Node.js with Express for the backend. The application allows users to create, edit, delete, and manage tasks with priorities and due dates.
